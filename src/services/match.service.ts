 ...
 * Create a new match
 */
export async function createMatch(matchData: Partial<MatchDocument>): Promise<MatchDocument> {
    try {
 ...
 */
export async function getMatchById(matchId: string): Promise<MatchDocument | null> {
    try {
 ...
 */
export async function getAllMatches(page: number, limit: number, options: PaginationOptions = {}): Promise<{
